...
enum
{
  autoware_system_msgs__msg__AutowareState__INITIALIZING = 1
};

/// Constant 'WAITING_FOR_ROUTE'.
enum
{
  autoware_system_msgs__msg__AutowareState__WAITING_FOR_ROUTE = 2
};

/// Constant 'PLANNING'.
enum
{
  autoware_system_msgs__msg__AutowareState__PLANNING = 3
};

/// Constant 'WAITING_FOR_ENGAGE'.
enum
{
  autoware_system_msgs__msg__AutowareState__WAITING_FOR_ENGAGE = 4
};

/// Constant 'DRIVING'.
enum
{
  autoware_system_msgs__msg__AutowareState__DRIVING = 5
};

/// Constant 'ARRIVED_GOAL'.
enum
{
  autoware_system_msgs__msg__AutowareState__ARRIVED_GOAL = 6
};

/// Constant 'FINALIZING'.
enum
{
  autoware_system_msgs__msg__AutowareState__FINALIZING = 7
};
