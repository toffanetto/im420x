...
#ifndef AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__TRAFFIC_LIGHT_ELEMENT__FUNCTIONS_H_
#define AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__TRAFFIC_LIGHT_ELEMENT__FUNCTIONS_H_
 ...
 * calls
 * autoware_perception_msgs__msg__TrafficLightElement__init().
...
/**
 * It calls
 * autoware_perception_msgs__msg__TrafficLightElement__fini()
 ...
 * autoware_perception_msgs__msg__TrafficLightElement__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * autoware_perception_msgs__msg__TrafficLightElement__Sequence__fini()
 * on the array,
...
#endif  // AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__TRAFFIC_LIGHT_ELEMENT__FUNCTIONS_H_
