...
: ${AMENT_CURRENT_PREFIX:="/home/toffanetto/subjects/im420x/project/ros2_ws/src/install/carla_serial_bridge"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/carla_serial_bridge/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/carla_serial_bridge/environment/path.sh"
