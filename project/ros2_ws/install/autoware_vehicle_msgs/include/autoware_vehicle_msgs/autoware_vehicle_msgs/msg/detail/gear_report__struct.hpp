...
#ifndef AUTOWARE_VEHICLE_MSGS__MSG__DETAIL__GEAR_REPORT__STRUCT_HPP_
#define AUTOWARE_VEHICLE_MSGS__MSG__DETAIL__GEAR_REPORT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_vehicle_msgs__msg__GearReport __attribute__((deprecated))
#else
# define DEPRECATED__autoware_vehicle_msgs__msg__GearReport __declspec(deprecated)
#endif
...
struct GearReport_
{
  ...
  // pointer types
  using RawPtr =
    autoware_vehicle_msgs::msg::GearReport_<ContainerAllocator> *;
  using ConstRawPtr =
    const autoware_vehicle_msgs::msg::GearReport_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_vehicle_msgs::msg::GearReport_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_vehicle_msgs::msg::GearReport_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_vehicle_msgs::msg::GearReport_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_vehicle_msgs::msg::GearReport_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_vehicle_msgs::msg::GearReport_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_vehicle_msgs::msg::GearReport_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_vehicle_msgs::msg::GearReport_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_vehicle_msgs__msg__GearReport
    std::shared_ptr<autoware_vehicle_msgs::msg::GearReport_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_vehicle_msgs__msg__GearReport
    std::shared_ptr<autoware_vehicle_msgs::msg::GearReport_<ContainerAllocator> const>
...
using GearReport =
  autoware_vehicle_msgs::msg::GearReport_<std::allocator<void>>;
...
#endif  // AUTOWARE_VEHICLE_MSGS__MSG__DETAIL__GEAR_REPORT__STRUCT_HPP_
