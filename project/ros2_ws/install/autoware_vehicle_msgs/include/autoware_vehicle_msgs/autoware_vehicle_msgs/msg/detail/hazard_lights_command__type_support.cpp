...
{
  new (message_memory) autoware_vehicle_msgs::msg::HazardLightsCommand(_init);
}

void HazardLightsCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_vehicle_msgs::msg::HazardLightsCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HazardLightsCommand_message_member_array[2] = {
  {
    ...
    offsetof(autoware_vehicle_msgs::msg::HazardLightsCommand, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs::msg::HazardLightsCommand, command),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HazardLightsCommand_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_vehicle_msgs::msg::HazardLightsCommand),
...
{
  return &::autoware_vehicle_msgs::msg::rosidl_typesupport_introspection_cpp::HazardLightsCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_vehicle_msgs, msg, HazardLightsCommand)() {
  return &::autoware_vehicle_msgs::msg::rosidl_typesupport_introspection_cpp::HazardLightsCommand_message_type_support_handle;
}
