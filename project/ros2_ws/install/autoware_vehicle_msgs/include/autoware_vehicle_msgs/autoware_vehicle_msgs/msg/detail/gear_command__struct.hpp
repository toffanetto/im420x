...
#ifndef AUTOWARE_VEHICLE_MSGS__MSG__DETAIL__GEAR_COMMAND__STRUCT_HPP_
#define AUTOWARE_VEHICLE_MSGS__MSG__DETAIL__GEAR_COMMAND__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_vehicle_msgs__msg__GearCommand __attribute__((deprecated))
#else
# define DEPRECATED__autoware_vehicle_msgs__msg__GearCommand __declspec(deprecated)
#endif
...
struct GearCommand_
{
  ...
  // pointer types
  using RawPtr =
    autoware_vehicle_msgs::msg::GearCommand_<ContainerAllocator> *;
  using ConstRawPtr =
    const autoware_vehicle_msgs::msg::GearCommand_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_vehicle_msgs::msg::GearCommand_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_vehicle_msgs::msg::GearCommand_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_vehicle_msgs::msg::GearCommand_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_vehicle_msgs::msg::GearCommand_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_vehicle_msgs::msg::GearCommand_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_vehicle_msgs::msg::GearCommand_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_vehicle_msgs::msg::GearCommand_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_vehicle_msgs__msg__GearCommand
    std::shared_ptr<autoware_vehicle_msgs::msg::GearCommand_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_vehicle_msgs__msg__GearCommand
    std::shared_ptr<autoware_vehicle_msgs::msg::GearCommand_<ContainerAllocator> const>
...
using GearCommand =
  autoware_vehicle_msgs::msg::GearCommand_<std::allocator<void>>;
...
#endif  // AUTOWARE_VEHICLE_MSGS__MSG__DETAIL__GEAR_COMMAND__STRUCT_HPP_
