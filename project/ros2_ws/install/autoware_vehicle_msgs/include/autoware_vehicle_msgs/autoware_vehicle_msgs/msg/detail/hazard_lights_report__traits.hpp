...
inline std::string to_yaml(const HazardLightsReport & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const autoware_vehicle_msgs::msg::HazardLightsReport & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const autoware_vehicle_msgs::msg::HazardLightsReport & msg)
{
