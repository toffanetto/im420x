...
{
  new (message_memory) autoware_vehicle_msgs::msg::VelocityReport(_init);
}

void VelocityReport_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_vehicle_msgs::msg::VelocityReport *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VelocityReport_message_member_array[4] = {
  {
    ...
    offsetof(autoware_vehicle_msgs::msg::VelocityReport, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs::msg::VelocityReport, longitudinal_velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs::msg::VelocityReport, lateral_velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs::msg::VelocityReport, heading_rate),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VelocityReport_message_members = {
  ...
  4,  // number of fields
  sizeof(autoware_vehicle_msgs::msg::VelocityReport),
...
{
  return &::autoware_vehicle_msgs::msg::rosidl_typesupport_introspection_cpp::VelocityReport_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_vehicle_msgs, msg, VelocityReport)() {
  return &::autoware_vehicle_msgs::msg::rosidl_typesupport_introspection_cpp::VelocityReport_message_type_support_handle;
}
