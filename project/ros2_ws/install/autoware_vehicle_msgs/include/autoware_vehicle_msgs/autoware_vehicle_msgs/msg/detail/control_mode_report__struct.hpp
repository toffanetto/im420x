...
#ifndef AUTOWARE_VEHICLE_MSGS__MSG__DETAIL__CONTROL_MODE_REPORT__STRUCT_HPP_
#define AUTOWARE_VEHICLE_MSGS__MSG__DETAIL__CONTROL_MODE_REPORT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_vehicle_msgs__msg__ControlModeReport __attribute__((deprecated))
#else
# define DEPRECATED__autoware_vehicle_msgs__msg__ControlModeReport __declspec(deprecated)
#endif
...
struct ControlModeReport_
{
  ...
  // pointer types
  using RawPtr =
    autoware_vehicle_msgs::msg::ControlModeReport_<ContainerAllocator> *;
  using ConstRawPtr =
    const autoware_vehicle_msgs::msg::ControlModeReport_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_vehicle_msgs::msg::ControlModeReport_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_vehicle_msgs::msg::ControlModeReport_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_vehicle_msgs::msg::ControlModeReport_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_vehicle_msgs::msg::ControlModeReport_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_vehicle_msgs::msg::ControlModeReport_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_vehicle_msgs::msg::ControlModeReport_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_vehicle_msgs::msg::ControlModeReport_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_vehicle_msgs__msg__ControlModeReport
    std::shared_ptr<autoware_vehicle_msgs::msg::ControlModeReport_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_vehicle_msgs__msg__ControlModeReport
    std::shared_ptr<autoware_vehicle_msgs::msg::ControlModeReport_<ContainerAllocator> const>
...
using ControlModeReport =
  autoware_vehicle_msgs::msg::ControlModeReport_<std::allocator<void>>;
...
#endif  // AUTOWARE_VEHICLE_MSGS__MSG__DETAIL__CONTROL_MODE_REPORT__STRUCT_HPP_
