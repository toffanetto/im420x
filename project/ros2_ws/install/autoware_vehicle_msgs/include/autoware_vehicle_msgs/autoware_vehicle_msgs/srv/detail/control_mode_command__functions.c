...
autoware_vehicle_msgs__srv__ControlModeCommand_Request__init(autoware_vehicle_msgs__srv__ControlModeCommand_Request * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    autoware_vehicle_msgs__srv__ControlModeCommand_Request__fini(msg);
    return false;
  }
  // mode
  return true;
...
autoware_vehicle_msgs__srv__ControlModeCommand_Request__create()
{
  ...
  autoware_vehicle_msgs__srv__ControlModeCommand_Request * msg = (autoware_vehicle_msgs__srv__ControlModeCommand_Request *)allocator.allocate(sizeof(autoware_vehicle_msgs__srv__ControlModeCommand_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(autoware_vehicle_msgs__srv__ControlModeCommand_Request));
  bool success = autoware_vehicle_msgs__srv__ControlModeCommand_Request__init(msg);
  if (!success) {
...
autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence__init(autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_vehicle_msgs__srv__ControlModeCommand_Request * data = NULL;

  if (size) {
    data = (autoware_vehicle_msgs__srv__ControlModeCommand_Request *)allocator.zero_allocate(size, sizeof(autoware_vehicle_msgs__srv__ControlModeCommand_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = autoware_vehicle_msgs__srv__ControlModeCommand_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        autoware_vehicle_msgs__srv__ControlModeCommand_Request__fini(&data[i - 1]);
      }
...
autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence__fini(autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      autoware_vehicle_msgs__srv__ControlModeCommand_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence * array = (autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence *)allocator.allocate(sizeof(autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence__init(array, size);
  if (!success) {
...
autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence__destroy(autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence__are_equal(const autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence * lhs, const autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_vehicle_msgs__srv__ControlModeCommand_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_vehicle_msgs__srv__ControlModeCommand_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_vehicle_msgs__srv__ControlModeCommand_Request * data =
      (autoware_vehicle_msgs__srv__ControlModeCommand_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_vehicle_msgs__srv__ControlModeCommand_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_vehicle_msgs__srv__ControlModeCommand_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_vehicle_msgs__srv__ControlModeCommand_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_vehicle_msgs__srv__ControlModeCommand_Response * msg = (autoware_vehicle_msgs__srv__ControlModeCommand_Response *)allocator.allocate(sizeof(autoware_vehicle_msgs__srv__ControlModeCommand_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(autoware_vehicle_msgs__srv__ControlModeCommand_Response));
  bool success = autoware_vehicle_msgs__srv__ControlModeCommand_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
autoware_vehicle_msgs__srv__ControlModeCommand_Response__destroy(autoware_vehicle_msgs__srv__ControlModeCommand_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    autoware_vehicle_msgs__srv__ControlModeCommand_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence__init(autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_vehicle_msgs__srv__ControlModeCommand_Response * data = NULL;

  if (size) {
    data = (autoware_vehicle_msgs__srv__ControlModeCommand_Response *)allocator.zero_allocate(size, sizeof(autoware_vehicle_msgs__srv__ControlModeCommand_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = autoware_vehicle_msgs__srv__ControlModeCommand_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        autoware_vehicle_msgs__srv__ControlModeCommand_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence__fini(autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      autoware_vehicle_msgs__srv__ControlModeCommand_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence * array = (autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence *)allocator.allocate(sizeof(autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence__destroy(autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence__are_equal(const autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence * lhs, const autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_vehicle_msgs__srv__ControlModeCommand_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_vehicle_msgs__srv__ControlModeCommand_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_vehicle_msgs__srv__ControlModeCommand_Response * data =
      (autoware_vehicle_msgs__srv__ControlModeCommand_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_vehicle_msgs__srv__ControlModeCommand_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_vehicle_msgs__srv__ControlModeCommand_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_vehicle_msgs__srv__ControlModeCommand_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
