...
[[deprecated("use autoware_vehicle_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const autoware_vehicle_msgs::srv::ControlModeCommand_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
  autoware_vehicle_msgs::srv::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use autoware_vehicle_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const autoware_vehicle_msgs::srv::ControlModeCommand_Request & msg)
{
  return autoware_vehicle_msgs::srv::to_yaml(msg);
}
...
[[deprecated("use autoware_vehicle_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const autoware_vehicle_msgs::srv::ControlModeCommand_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  autoware_vehicle_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use autoware_vehicle_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const autoware_vehicle_msgs::srv::ControlModeCommand_Response & msg)
{
  return autoware_vehicle_msgs::srv::to_yaml(msg);
}
