...
class Metaclass_ControlModeCommand_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('autoware_vehicle_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_ControlModeCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from autoware_vehicle_msgs.srv import _control_mode_command
...
class ControlModeCommand(metaclass=Metaclass_ControlModeCommand):
    from autoware_vehicle_msgs.srv._control_mode_command import ControlModeCommand_Request as Request
    from autoware_vehicle_msgs.srv._control_mode_command import ControlModeCommand_Response as Response
