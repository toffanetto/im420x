...
class Path(metaclass=Metaclass_Path):
    ...
    _fields_and_field_types = {
        ...
        'points': 'sequence<autoware_planning_msgs/PathPoint>',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['autoware_planning_msgs', 'msg'], 'PathPoint')),  # noqa: E501
