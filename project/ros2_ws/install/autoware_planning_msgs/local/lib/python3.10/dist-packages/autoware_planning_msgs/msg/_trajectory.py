...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    _fields_and_field_types = {
        ...
        'points': 'sequence<autoware_planning_msgs/TrajectoryPoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['autoware_planning_msgs', 'msg'], 'TrajectoryPoint')),  # noqa: E501
    )
