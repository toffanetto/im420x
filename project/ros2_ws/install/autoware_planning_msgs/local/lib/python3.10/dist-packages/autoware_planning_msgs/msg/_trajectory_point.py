...
class TrajectoryPoint(metaclass=Metaclass_TrajectoryPoint):
    ...
    def __init__(self, **kwargs):
        ...
        self.longitudinal_velocity_mps = kwargs.get('longitudinal_velocity_mps', float())
        self.lateral_velocity_mps = kwargs.get('lateral_velocity_mps', float())
        self.acceleration_mps2 = kwargs.get('acceleration_mps2', float())
        self.heading_rate_rps = kwargs.get('heading_rate_rps', float())
        self.front_wheel_angle_rad = kwargs.get('front_wheel_angle_rad', float())
        self.rear_wheel_angle_rad = kwargs.get('rear_wheel_angle_rad', float())
