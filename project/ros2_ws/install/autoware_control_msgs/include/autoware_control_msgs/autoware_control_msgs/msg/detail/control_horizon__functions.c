...
autoware_control_msgs__msg__ControlHorizon__create()
{
  ...
  autoware_control_msgs__msg__ControlHorizon * msg = (autoware_control_msgs__msg__ControlHorizon *)allocator.allocate(sizeof(autoware_control_msgs__msg__ControlHorizon), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_control_msgs__msg__ControlHorizon__Sequence__init(autoware_control_msgs__msg__ControlHorizon__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_control_msgs__msg__ControlHorizon *)allocator.zero_allocate(size, sizeof(autoware_control_msgs__msg__ControlHorizon), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_control_msgs__msg__ControlHorizon__Sequence * array = (autoware_control_msgs__msg__ControlHorizon__Sequence *)allocator.allocate(sizeof(autoware_control_msgs__msg__ControlHorizon__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  autoware_control_msgs__msg__ControlHorizon__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_control_msgs__msg__ControlHorizon * data =
      (autoware_control_msgs__msg__ControlHorizon *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_control_msgs__msg__ControlHorizon__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_control_msgs__msg__ControlHorizon__fini(&output->data[i]);
        }
        return false;
      }
    }
