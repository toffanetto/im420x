...
void fetch_function__ControlHorizon__controls(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const autoware_control_msgs::msg::Control *>(
    get_const_function__ControlHorizon__controls(untyped_member, index));
  auto & value = *reinterpret_cast<autoware_control_msgs::msg::Control *>(untyped_value);
  value = item;
}

void assign_function__ControlHorizon__controls(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<autoware_control_msgs::msg::Control *>(
    get_function__ControlHorizon__controls(untyped_member, index));
  const auto & value = *reinterpret_cast<const autoware_control_msgs::msg::Control *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ControlHorizon_message_member_array[4] = {
  ...
  },
  {
    ...
    fetch_function__ControlHorizon__controls,  // fetch(index, &value) function pointer
    assign_function__ControlHorizon__controls,  // assign(index, value) function pointer
