...
#ifndef KARTECH_LINEAR_ACTUATOR_MSGS__MSG__CONFIGURE_OUTPUTS_KP_KI_CMD_H_
#define KARTECH_LINEAR_ACTUATOR_MSGS__MSG__CONFIGURE_OUTPUTS_KP_KI_CMD_H_
...
#endif  // KARTECH_LINEAR_ACTUATOR_MSGS__MSG__CONFIGURE_OUTPUTS_KP_KI_CMD_H_
