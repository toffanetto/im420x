...
bool kartech_linear_actuator_msgs__msg__motor_over_current_config_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kartech_linear_actuator_msgs.msg._motor_over_current_config_cmd.MotorOverCurrentConfigCmd", full_classname_dest, 89) == 0);
  }
  kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd * ros_message = _ros_message;
  {  // header
  ...
  {  // over_current
    ...
    ros_message->over_current = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of MotorOverCurrentConfigCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kartech_linear_actuator_msgs.msg._motor_over_current_config_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotorOverCurrentConfigCmd");
