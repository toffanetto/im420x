...
class Metaclass_PositionRpt(type):
    """Metaclass of message 'PositionRpt'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'kartech_linear_actuator_msgs.msg.PositionRpt')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__position_rpt
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__position_rpt
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__position_rpt
            cls._TYPE_SUPPORT = module.type_support_msg__msg__position_rpt
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__position_rpt
...
class PositionRpt(metaclass=Metaclass_PositionRpt):
    """Message class 'PositionRpt'."""
