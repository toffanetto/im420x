...
bool kartech_linear_actuator_msgs__msg__software_version_req__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kartech_linear_actuator_msgs.msg._software_version_req.SoftwareVersionReq", full_classname_dest, 73) == 0);
  }
  kartech_linear_actuator_msgs__msg__SoftwareVersionReq * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of SoftwareVersionReq */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kartech_linear_actuator_msgs.msg._software_version_req");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SoftwareVersionReq");
