...
bool delphi_esr_msgs__msg__esr_track_motion_power_track__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("delphi_esr_msgs.msg._esr_track_motion_power_track.EsrTrackMotionPowerTrack", full_classname_dest, 74) == 0);
  }
  delphi_esr_msgs__msg__EsrTrackMotionPowerTrack * ros_message = _ros_message;
  {  // id
  ...
  {  // movable_fast
    PyObject * field = PyObject_GetAttrString(_pymsg, "movable_fast");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->movable_fast = (Py_True == field);
    Py_DECREF(field);
  }
  {  // movable_slow
    PyObject * field = PyObject_GetAttrString(_pymsg, "movable_slow");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->movable_slow = (Py_True == field);
    Py_DECREF(field);
  }
  {  // moving
...
{
  /* NOTE(esteve): Call constructor of EsrTrackMotionPowerTrack */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("delphi_esr_msgs.msg._esr_track_motion_power_track");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EsrTrackMotionPowerTrack");
  ...
  {  // movable_fast
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->movable_fast ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "movable_fast", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // movable_slow
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->movable_slow ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "movable_slow", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
