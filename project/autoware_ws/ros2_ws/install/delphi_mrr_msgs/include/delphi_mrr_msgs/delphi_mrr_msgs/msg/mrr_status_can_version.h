...
#ifndef DELPHI_MRR_MSGS__MSG__MRR_STATUS_CAN_VERSION_H_
#define DELPHI_MRR_MSGS__MSG__MRR_STATUS_CAN_VERSION_H_
...
#endif  // DELPHI_MRR_MSGS__MSG__MRR_STATUS_CAN_VERSION_H_
