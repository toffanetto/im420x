...
bool derived_object_msgs__msg__object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("derived_object_msgs.msg._object.Object", full_classname_dest, 38) == 0);
  }
  derived_object_msgs__msg__Object * ros_message = _ros_message;
  {  // header
  ...
  {  // detection_level
    PyObject * field = PyObject_GetAttrString(_pymsg, "detection_level");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->detection_level = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // object_classified
    PyObject * field = PyObject_GetAttrString(_pymsg, "object_classified");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->object_classified = (Py_True == field);
    Py_DECREF(field);
  }
  {  // pose
...
PyObject * derived_object_msgs__msg__object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("derived_object_msgs.msg._object");
  ...
  {  // detection_level
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->detection_level);
    {
      int rc = PyObject_SetAttrString(_pymessage, "detection_level", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // object_classified
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->object_classified ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "object_classified", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
