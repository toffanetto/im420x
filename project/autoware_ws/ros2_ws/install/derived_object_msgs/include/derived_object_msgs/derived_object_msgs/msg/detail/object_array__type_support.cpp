...
{
  new (message_memory) derived_object_msgs::msg::ObjectArray(_init);
}

void ObjectArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<derived_object_msgs::msg::ObjectArray *>(message_memory);
  typed_message->~ObjectArray();
}

size_t size_function__ObjectArray__objects(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<derived_object_msgs::msg::Object> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<derived_object_msgs::msg::Object> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<derived_object_msgs::msg::Object> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const derived_object_msgs::msg::Object *>(
    get_const_function__ObjectArray__objects(untyped_member, index));
  auto & value = *reinterpret_cast<derived_object_msgs::msg::Object *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<derived_object_msgs::msg::Object *>(
    get_function__ObjectArray__objects(untyped_member, index));
  const auto & value = *reinterpret_cast<const derived_object_msgs::msg::Object *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectArray_message_member_array[2] = {
  {
    ...
    offsetof(derived_object_msgs::msg::ObjectArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<derived_object_msgs::msg::Object>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(derived_object_msgs::msg::ObjectArray, objects),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectArray_message_members = {
  ...
  2,  // number of fields
  sizeof(derived_object_msgs::msg::ObjectArray),
...
get_message_type_support_handle<derived_object_msgs::msg::ObjectArray>()
{
  return &::derived_object_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, derived_object_msgs, msg, ObjectArray)() {
  return &::derived_object_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectArray_message_type_support_handle;
}
