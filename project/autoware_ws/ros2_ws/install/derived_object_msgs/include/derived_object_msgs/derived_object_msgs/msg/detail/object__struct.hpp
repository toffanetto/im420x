...
#ifndef DERIVED_OBJECT_MSGS__MSG__DETAIL__OBJECT__STRUCT_HPP_
#define DERIVED_OBJECT_MSGS__MSG__DETAIL__OBJECT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__derived_object_msgs__msg__Object __attribute__((deprecated))
#else
# define DEPRECATED__derived_object_msgs__msg__Object __declspec(deprecated)
#endif
...
struct Object_
{
  ...
  // pointer types
  using RawPtr =
    derived_object_msgs::msg::Object_<ContainerAllocator> *;
  using ConstRawPtr =
    const derived_object_msgs::msg::Object_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<derived_object_msgs::msg::Object_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<derived_object_msgs::msg::Object_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      derived_object_msgs::msg::Object_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<derived_object_msgs::msg::Object_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<derived_object_msgs::msg::Object_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<derived_object_msgs::msg::Object_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<derived_object_msgs::msg::Object_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__derived_object_msgs__msg__Object
    std::shared_ptr<derived_object_msgs::msg::Object_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__derived_object_msgs__msg__Object
    std::shared_ptr<derived_object_msgs::msg::Object_<ContainerAllocator> const>
...
using Object =
  derived_object_msgs::msg::Object_<std::allocator<void>>;
...
#endif  // DERIVED_OBJECT_MSGS__MSG__DETAIL__OBJECT__STRUCT_HPP_
