...
#ifndef NEOBOTIX_USBOARD_MSGS__MSG__DETAIL__COMMAND__FUNCTIONS_H_
#define NEOBOTIX_USBOARD_MSGS__MSG__DETAIL__COMMAND__FUNCTIONS_H_
 ...
 * calls
 * neobotix_usboard_msgs__msg__Command__init().
...
/**
 * It calls
 * neobotix_usboard_msgs__msg__Command__fini()
 ...
 * neobotix_usboard_msgs__msg__Command__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * neobotix_usboard_msgs__msg__Command__Sequence__fini()
 * on the array,
...
#endif  // NEOBOTIX_USBOARD_MSGS__MSG__DETAIL__COMMAND__FUNCTIONS_H_
