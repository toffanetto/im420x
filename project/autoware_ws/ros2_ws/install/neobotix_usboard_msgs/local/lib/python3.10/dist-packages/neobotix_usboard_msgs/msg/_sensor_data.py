    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'neobotix_usboard_msgs.msg.SensorData')
            logger.debug(
...
class SensorData(metaclass=Metaclass_SensorData):
    ...
    def __init__(self, **kwargs):
        ...
        self.warn = kwargs.get('warn', bool())
        self.alarm = kwargs.get('alarm', bool())
    ...
    def warn(self, value):
        if __debug__:
            assert \
                ...
                "The 'warn' field must be of type 'bool'"
        self._warn = value
    ...
    def alarm(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'alarm' field must be of type 'bool'"
        self._alarm = value
