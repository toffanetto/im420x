...
bool neobotix_usboard_msgs__msg__sensor_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("neobotix_usboard_msgs.msg._sensor_data.SensorData", full_classname_dest, 49) == 0);
  }
  neobotix_usboard_msgs__msg__SensorData * ros_message = _ros_message;
  {  // distance
  ...
  {  // warn
    PyObject * field = PyObject_GetAttrString(_pymsg, "warn");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->warn = (Py_True == field);
    Py_DECREF(field);
  }
  {  // alarm
    ...
    assert(PyBool_Check(field));
    ros_message->alarm = (Py_True == field);
    Py_DECREF(field);
  }
  {  // active
...
PyObject * neobotix_usboard_msgs__msg__sensor_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("neobotix_usboard_msgs.msg._sensor_data");
  ...
  {  // warn
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->warn ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "warn", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // alarm
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->alarm ? 1 : 0);
    {
