...
static rosidl_typesupport_introspection_c__MessageMember carla_msgs__srv__SpawnObject_Request__rosidl_typesupport_introspection_c__SpawnObject_Request_message_member_array[7] = {
  {
    "type",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(carla_msgs__srv__SpawnObject_Request, frame_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carla_msgs, srv, SpawnObject_Request)() {
  ...
  carla_msgs__srv__SpawnObject_Request__rosidl_typesupport_introspection_c__SpawnObject_Request_message_member_array[4].members_ =
