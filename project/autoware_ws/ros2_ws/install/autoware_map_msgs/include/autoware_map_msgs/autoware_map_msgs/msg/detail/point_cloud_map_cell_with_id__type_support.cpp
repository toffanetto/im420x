...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PointCloudMapCellWithID_message_member_array[3] = {
  {
    "cell_id",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_map_msgs::msg::PointCloudMapCellWithID, metadata),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
