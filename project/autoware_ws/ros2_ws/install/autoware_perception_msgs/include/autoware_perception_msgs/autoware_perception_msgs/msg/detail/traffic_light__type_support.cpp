...
{
  new (message_memory) autoware_perception_msgs::msg::TrafficLight(_init);
}

void TrafficLight_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_perception_msgs::msg::TrafficLight *>(message_memory);
  typed_message->~TrafficLight();
}

size_t size_function__TrafficLight__elements(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<autoware_perception_msgs::msg::TrafficLightElement> *>(untyped_member);
  return member->size();
}

const void * get_const_function__TrafficLight__elements(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__TrafficLight__elements(void * untyped_member, size_t index)
{
  auto & member =
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrafficLight_message_member_array[2] = {
  {
    ...
    offsetof(autoware_perception_msgs::msg::TrafficLight, traffic_light_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::TrafficLight, elements),  // bytes offset in struct
    nullptr,  // default value
    size_function__TrafficLight__elements,  // size() function pointer
    get_const_function__TrafficLight__elements,  // get_const(index) function pointer
    get_function__TrafficLight__elements,  // get(index) function pointer
    fetch_function__TrafficLight__elements,  // fetch(index, &value) function pointer
    assign_function__TrafficLight__elements,  // assign(index, value) function pointer
    resize_function__TrafficLight__elements  // resize(index) function pointer
  }
};
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrafficLight_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_perception_msgs::msg::TrafficLight),
...
get_message_type_support_handle<autoware_perception_msgs::msg::TrafficLight>()
{
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::TrafficLight_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_perception_msgs, msg, TrafficLight)() {
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::TrafficLight_message_type_support_handle;
}
