...
ibeo_msgs__msg__HostVehicleState2807__init(ibeo_msgs__msg__HostVehicleState2807 * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    ibeo_msgs__msg__HostVehicleState2807__fini(msg);
    return false;
  }
  // ibeo_header
...
ibeo_msgs__msg__HostVehicleState2807__create()
{
  ...
  ibeo_msgs__msg__HostVehicleState2807 * msg = (ibeo_msgs__msg__HostVehicleState2807 *)allocator.allocate(sizeof(ibeo_msgs__msg__HostVehicleState2807), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ibeo_msgs__msg__HostVehicleState2807));
  bool success = ibeo_msgs__msg__HostVehicleState2807__init(msg);
  if (!success) {
...
ibeo_msgs__msg__HostVehicleState2807__Sequence__init(ibeo_msgs__msg__HostVehicleState2807__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ibeo_msgs__msg__HostVehicleState2807 * data = NULL;

  if (size) {
    data = (ibeo_msgs__msg__HostVehicleState2807 *)allocator.zero_allocate(size, sizeof(ibeo_msgs__msg__HostVehicleState2807), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ibeo_msgs__msg__HostVehicleState2807__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ibeo_msgs__msg__HostVehicleState2807__fini(&data[i - 1]);
      }
...
ibeo_msgs__msg__HostVehicleState2807__Sequence__fini(ibeo_msgs__msg__HostVehicleState2807__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ibeo_msgs__msg__HostVehicleState2807__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ibeo_msgs__msg__HostVehicleState2807__Sequence * array = (ibeo_msgs__msg__HostVehicleState2807__Sequence *)allocator.allocate(sizeof(ibeo_msgs__msg__HostVehicleState2807__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ibeo_msgs__msg__HostVehicleState2807__Sequence__init(array, size);
  if (!success) {
...
ibeo_msgs__msg__HostVehicleState2807__Sequence__destroy(ibeo_msgs__msg__HostVehicleState2807__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ibeo_msgs__msg__HostVehicleState2807__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ibeo_msgs__msg__HostVehicleState2807__Sequence__are_equal(const ibeo_msgs__msg__HostVehicleState2807__Sequence * lhs, const ibeo_msgs__msg__HostVehicleState2807__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ibeo_msgs__msg__HostVehicleState2807__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ibeo_msgs__msg__HostVehicleState2807__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ibeo_msgs__msg__HostVehicleState2807);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ibeo_msgs__msg__HostVehicleState2807 * data =
      (ibeo_msgs__msg__HostVehicleState2807 *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ibeo_msgs__msg__HostVehicleState2807__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ibeo_msgs__msg__HostVehicleState2807__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ibeo_msgs__msg__HostVehicleState2807__copy(
