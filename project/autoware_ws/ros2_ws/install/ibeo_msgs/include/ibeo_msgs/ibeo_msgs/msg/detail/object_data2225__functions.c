...
ibeo_msgs__msg__ObjectData2225__create()
{
  ...
  ibeo_msgs__msg__ObjectData2225 * msg = (ibeo_msgs__msg__ObjectData2225 *)allocator.allocate(sizeof(ibeo_msgs__msg__ObjectData2225), allocator.state);
  if (!msg) {
    return NULL;
  }
...
ibeo_msgs__msg__ObjectData2225__Sequence__init(ibeo_msgs__msg__ObjectData2225__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ibeo_msgs__msg__ObjectData2225 *)allocator.zero_allocate(size, sizeof(ibeo_msgs__msg__ObjectData2225), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ibeo_msgs__msg__ObjectData2225__Sequence * array = (ibeo_msgs__msg__ObjectData2225__Sequence *)allocator.allocate(sizeof(ibeo_msgs__msg__ObjectData2225__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  ibeo_msgs__msg__ObjectData2225__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ibeo_msgs__msg__ObjectData2225 * data =
      (ibeo_msgs__msg__ObjectData2225 *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ibeo_msgs__msg__ObjectData2225__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ibeo_msgs__msg__ObjectData2225__fini(&output->data[i]);
        }
        return false;
      }
    }
