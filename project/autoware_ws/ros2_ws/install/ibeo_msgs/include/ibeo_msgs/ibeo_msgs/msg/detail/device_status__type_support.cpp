...
{
  new (message_memory) ibeo_msgs::msg::DeviceStatus(_init);
}

void DeviceStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ibeo_msgs::msg::DeviceStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DeviceStatus_message_member_array[5] = {
  {
    ...
    offsetof(ibeo_msgs::msg::DeviceStatus, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ibeo_msgs::msg::DeviceStatus, ibeo_header),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ibeo_msgs::msg::DeviceStatus, scanner_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ibeo_msgs::msg::DeviceStatus, sensor_temperature),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ibeo_msgs::msg::DeviceStatus, frequency),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DeviceStatus_message_members = {
  ...
  5,  // number of fields
  sizeof(ibeo_msgs::msg::DeviceStatus),
...
get_message_type_support_handle<ibeo_msgs::msg::DeviceStatus>()
{
  return &::ibeo_msgs::msg::rosidl_typesupport_introspection_cpp::DeviceStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ibeo_msgs, msg, DeviceStatus)() {
  return &::ibeo_msgs::msg::rosidl_typesupport_introspection_cpp::DeviceStatus_message_type_support_handle;
}
