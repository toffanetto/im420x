...
bool ibeo_msgs__msg__point2_di__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ibeo_msgs.msg._point2_di.Point2Di", full_classname_dest, 33) == 0);
  }
  ibeo_msgs__msg__Point2Di * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of Point2Di */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ibeo_msgs.msg._point2_di");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Point2Di");
