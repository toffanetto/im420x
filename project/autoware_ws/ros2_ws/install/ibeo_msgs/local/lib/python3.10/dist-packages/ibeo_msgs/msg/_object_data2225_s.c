...
bool ibeo_msgs__msg__object_data2225__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ibeo_msgs.msg._object_data2225.ObjectData2225", full_classname_dest, 45) == 0);
  }
  ibeo_msgs__msg__ObjectData2225 * ros_message = _ros_message;
  {  // header
  ...
  {  // mid_scan_timestamp
    PyObject * field = PyObject_GetAttrString(_pymsg, "mid_scan_timestamp");
    if (!field) {
      return false;
    }
    if (!builtin_interfaces__msg__time__convert_from_py(field, &ros_message->mid_scan_timestamp)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // object_list
    ...
    if (!ibeo_msgs__msg__Object2225__Sequence__init(&(ros_message->object_list), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ibeo_msgs__msg__Object2225__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ibeo_msgs__msg__Object2225 * dest = ros_message->object_list.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ibeo_msgs__msg__object2225__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of ObjectData2225 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ibeo_msgs.msg._object_data2225");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectData2225");
  ...
  {  // mid_scan_timestamp
    PyObject * field = NULL;
    field = builtin_interfaces__msg__time__convert_to_py(&ros_message->mid_scan_timestamp);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "mid_scan_timestamp", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // object_list
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ibeo_msgs__msg__object2225__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
