...
bool ibeo_msgs__msg__scan_point2208__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ibeo_msgs.msg._scan_point2208.ScanPoint2208", full_classname_dest, 43) == 0);
  }
  ibeo_msgs__msg__ScanPoint2208 * ros_message = _ros_message;
  {  // echo
...
{
  /* NOTE(esteve): Call constructor of ScanPoint2208 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ibeo_msgs.msg._scan_point2208");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ScanPoint2208");
