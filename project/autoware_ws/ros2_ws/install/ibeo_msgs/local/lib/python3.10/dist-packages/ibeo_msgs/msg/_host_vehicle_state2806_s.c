...
bool ibeo_msgs__msg__host_vehicle_state2806__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ibeo_msgs.msg._host_vehicle_state2806.HostVehicleState2806", full_classname_dest, 58) == 0);
  }
  ibeo_msgs__msg__HostVehicleState2806 * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of HostVehicleState2806 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ibeo_msgs.msg._host_vehicle_state2806");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HostVehicleState2806");
