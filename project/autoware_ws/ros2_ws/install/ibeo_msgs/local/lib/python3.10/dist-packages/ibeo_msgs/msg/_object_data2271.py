...
class Metaclass_ObjectData2271(type):
    """Metaclass of message 'ObjectData2271'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ibeo_msgs.msg.ObjectData2271')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__object_data2271
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__object_data2271
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__object_data2271
            cls._TYPE_SUPPORT = module.type_support_msg__msg__object_data2271
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__object_data2271
            ...
            from ibeo_msgs.msg import Object2271
            if Object2271.__class__._TYPE_SUPPORT is None:
                Object2271.__class__.__import_type_support__()
...
class ObjectData2271(metaclass=Metaclass_ObjectData2271):
    """Message class 'ObjectData2271'."""
    ...
    _fields_and_field_types = {
        ...
        'object_list': 'sequence<ibeo_msgs/Object2271>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('uint16'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ibeo_msgs', 'msg'], 'Object2271')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Object2271) for v in value) and
                 True), \
                "The 'object_list' field must be a set or sequence and each value of type 'Object2271'"
