...
bool ibeo_msgs__msg__object_data2280__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ibeo_msgs.msg._object_data2280.ObjectData2280", full_classname_dest, 45) == 0);
  }
  ibeo_msgs__msg__ObjectData2280 * ros_message = _ros_message;
  {  // header
  ...
  {  // objects
    ...
    if (!ibeo_msgs__msg__Object2280__Sequence__init(&(ros_message->objects), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ibeo_msgs__msg__Object2280__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ibeo_msgs__msg__Object2280 * dest = ros_message->objects.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ibeo_msgs__msg__object2280__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of ObjectData2280 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ibeo_msgs.msg._object_data2280");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectData2280");
  ...
  {  // objects
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ibeo_msgs__msg__object2280__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
