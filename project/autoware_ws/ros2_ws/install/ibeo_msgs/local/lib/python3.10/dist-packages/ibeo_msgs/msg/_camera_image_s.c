...
bool ibeo_msgs__msg__camera_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ibeo_msgs.msg._camera_image.CameraImage", full_classname_dest, 39) == 0);
  }
  ibeo_msgs__msg__CameraImage * ros_message = _ros_message;
  {  // header
  ...
  {  // image_format
    ...
    ros_message->image_format = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // us_since_power_on
    PyObject * field = PyObject_GetAttrString(_pymsg, "us_since_power_on");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->us_since_power_on = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // timestamp
  ...
  {  // horizontal_opening_angle
    PyObject * field = PyObject_GetAttrString(_pymsg, "horizontal_opening_angle");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->horizontal_opening_angle = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // vertical_opening_angle
    PyObject * field = PyObject_GetAttrString(_pymsg, "vertical_opening_angle");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->vertical_opening_angle = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // image_width
  ...
  {  // image_buffer
    PyObject * field = PyObject_GetAttrString(_pymsg, "image_buffer");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->image_buffer.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'image_buffer'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of CameraImage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ibeo_msgs.msg._camera_image");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CameraImage");
  ...
  {  // image_format
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->image_format);
    {
  ...
  {  // us_since_power_on
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->us_since_power_on);
    {
      int rc = PyObject_SetAttrString(_pymessage, "us_since_power_on", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // horizontal_opening_angle
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->horizontal_opening_angle);
    {
      int rc = PyObject_SetAttrString(_pymessage, "horizontal_opening_angle", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // vertical_opening_angle
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->vertical_opening_angle);
    {
      int rc = PyObject_SetAttrString(_pymessage, "vertical_opening_angle", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // image_buffer
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "image_buffer");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->image_buffer.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->image_buffer.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->image_buffer.size * sizeof(uint8_t));
      assert(data != NULL);
