...
bool ibeo_msgs__msg__size2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ibeo_msgs.msg._size2_d.Size2D", full_classname_dest, 29) == 0);
  }
  ibeo_msgs__msg__Size2D * ros_message = _ros_message;
  {  // size_x
    ...
    ros_message->size_x = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // size_y
    ...
    assert(PyLong_Check(field));
    ros_message->size_y = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of Size2D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ibeo_msgs.msg._size2_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Size2D");
