...
enum
{
  autoware_auto_perception_msgs__msg__TrafficLight__UP_LEFT_ARROW = 9
};

/// Constant 'UP_RIGHT_ARROW'.
enum
{
  autoware_auto_perception_msgs__msg__TrafficLight__UP_RIGHT_ARROW = 10
};

/// Constant 'DOWN_ARROW'.
enum
{
  autoware_auto_perception_msgs__msg__TrafficLight__DOWN_ARROW = 11
};

/// Constant 'DOWN_LEFT_ARROW'.
enum
{
  autoware_auto_perception_msgs__msg__TrafficLight__DOWN_LEFT_ARROW = 12
};

/// Constant 'DOWN_RIGHT_ARROW'.
enum
{
  autoware_auto_perception_msgs__msg__TrafficLight__DOWN_RIGHT_ARROW = 13
};

/// Constant 'CROSS'.
enum
{
  autoware_auto_perception_msgs__msg__TrafficLight__CROSS = 14
};

/// Constant 'SOLID_OFF'.
enum
{
  autoware_auto_perception_msgs__msg__TrafficLight__SOLID_OFF = 15
};

/// Constant 'SOLID_ON'.
enum
{
  autoware_auto_perception_msgs__msg__TrafficLight__SOLID_ON = 16
};

/// Constant 'FLASHING'.
enum
{
  autoware_auto_perception_msgs__msg__TrafficLight__FLASHING = 17
};

/// Constant 'UNKNOWN'.
enum
{
  autoware_auto_perception_msgs__msg__TrafficLight__UNKNOWN = 18
};
