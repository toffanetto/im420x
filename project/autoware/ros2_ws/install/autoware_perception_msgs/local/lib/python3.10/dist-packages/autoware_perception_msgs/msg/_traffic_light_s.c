...
bool autoware_perception_msgs__msg__traffic_light__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_perception_msgs.msg._traffic_light.TrafficLight", full_classname_dest, 56) == 0);
  }
  autoware_perception_msgs__msg__TrafficLight * ros_message = _ros_message;
  {  // traffic_light_id
...
PyObject * autoware_perception_msgs__msg__traffic_light__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_perception_msgs.msg._traffic_light");
