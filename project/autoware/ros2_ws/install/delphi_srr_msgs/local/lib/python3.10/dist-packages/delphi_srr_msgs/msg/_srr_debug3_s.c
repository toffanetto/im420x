...
bool delphi_srr_msgs__msg__srr_debug3__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("delphi_srr_msgs.msg._srr_debug3.SrrDebug3", full_classname_dest, 41) == 0);
  }
  delphi_srr_msgs__msg__SrrDebug3 * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of SrrDebug3 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("delphi_srr_msgs.msg._srr_debug3");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SrrDebug3");
