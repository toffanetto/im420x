  ...
  std::ostream & out)
{
  ...
  {
    out << "transparent: ";
    rosidl_generator_traits::value_to_yaml(msg.transparent, out);
  }
  out << "}";
...
inline std::string to_yaml(const ScanPoint2205 & msg, bool use_flow_style = false)
{
