...
ibeo_msgs__msg__Velocity2D__create()
{
  ...
  ibeo_msgs__msg__Velocity2D * msg = (ibeo_msgs__msg__Velocity2D *)allocator.allocate(sizeof(ibeo_msgs__msg__Velocity2D), allocator.state);
  if (!msg) {
    return NULL;
  }
...
ibeo_msgs__msg__Velocity2D__Sequence__init(ibeo_msgs__msg__Velocity2D__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ibeo_msgs__msg__Velocity2D *)allocator.zero_allocate(size, sizeof(ibeo_msgs__msg__Velocity2D), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ibeo_msgs__msg__Velocity2D__Sequence * array = (ibeo_msgs__msg__Velocity2D__Sequence *)allocator.allocate(sizeof(ibeo_msgs__msg__Velocity2D__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  ibeo_msgs__msg__Velocity2D__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ibeo_msgs__msg__Velocity2D * data =
      (ibeo_msgs__msg__Velocity2D *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ibeo_msgs__msg__Velocity2D__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ibeo_msgs__msg__Velocity2D__fini(&output->data[i]);
        }
        return false;
      }
    }
