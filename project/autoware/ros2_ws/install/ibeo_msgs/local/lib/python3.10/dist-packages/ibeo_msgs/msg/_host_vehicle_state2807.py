...
class Metaclass_HostVehicleState2807(type):
    """Metaclass of message 'HostVehicleState2807'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ibeo_msgs.msg.HostVehicleState2807')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__host_vehicle_state2807
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__host_vehicle_state2807
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__host_vehicle_state2807
            cls._TYPE_SUPPORT = module.type_support_msg__msg__host_vehicle_state2807
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__host_vehicle_state2807
...
class HostVehicleState2807(metaclass=Metaclass_HostVehicleState2807):
    """Message class 'HostVehicleState2807'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.longitudinal_acceleration = kwargs.get('longitudinal_acceleration', float())
    ...
    def longitudinal_acceleration(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'longitudinal_acceleration' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'longitudinal_acceleration' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
