...
bool ibeo_msgs__msg__scan_point2204__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * ibeo_msgs__msg__scan_point2204__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool ibeo_msgs__msg__scan_data2204__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ibeo_msgs.msg._scan_data2204.ScanData2204", full_classname_dest, 41) == 0);
  }
  ibeo_msgs__msg__ScanData2204 * ros_message = _ros_message;
  {  // header
  ...
  {  // scan_start_time
    ...
    ros_message->scan_start_time = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // scan_end_time_offset
    ...
    assert(PyLong_Check(field));
    ros_message->scan_end_time_offset = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // ground_labeled
  ...
  {  // number_of_scanner_infos
    ...
    assert(PyLong_Check(field));
    ros_message->number_of_scanner_infos = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // scanner_info_list
    ...
    if (!ibeo_msgs__msg__ScannerInfo2204__Sequence__init(&(ros_message->scanner_info_list), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ibeo_msgs__msg__ScannerInfo2204__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ibeo_msgs__msg__ScannerInfo2204 * dest = ros_message->scanner_info_list.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ibeo_msgs__msg__scanner_info2204__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // scan_point_list
    ...
    if (!ibeo_msgs__msg__ScanPoint2204__Sequence__init(&(ros_message->scan_point_list), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ibeo_msgs__msg__ScanPoint2204__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ibeo_msgs__msg__ScanPoint2204 * dest = ros_message->scan_point_list.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ibeo_msgs__msg__scan_point2204__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of ScanData2204 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ibeo_msgs.msg._scan_data2204");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ScanData2204");
  ...
  {  // scan_start_time
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->scan_start_time);
    {
  ...
  {  // scanner_info_list
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ibeo_msgs__msg__scanner_info2204__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // scan_point_list
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ibeo_msgs__msg__scan_point2204__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
