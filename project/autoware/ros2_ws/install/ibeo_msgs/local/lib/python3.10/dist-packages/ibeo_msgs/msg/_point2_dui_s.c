...
bool ibeo_msgs__msg__point2_dui__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ibeo_msgs.msg._point2_dui.Point2Dui", full_classname_dest, 35) == 0);
  }
  ibeo_msgs__msg__Point2Dui * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of Point2Dui */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ibeo_msgs.msg._point2_dui");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Point2Dui");
