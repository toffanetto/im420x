...
[[deprecated("use autoware_common_msgs::msg::to_block_style_yaml() instead")]]
inline void to_yaml(
  const autoware_common_msgs::msg::ResponseStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
  autoware_common_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use autoware_common_msgs::msg::to_yaml() instead")]]
inline std::string to_yaml(const autoware_common_msgs::msg::ResponseStatus & msg)
{
  return autoware_common_msgs::msg::to_yaml(msg);
}
