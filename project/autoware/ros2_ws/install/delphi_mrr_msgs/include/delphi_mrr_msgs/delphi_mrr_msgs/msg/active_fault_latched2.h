...
#ifndef DELPHI_MRR_MSGS__MSG__ACTIVE_FAULT_LATCHED2_H_
#define DELPHI_MRR_MSGS__MSG__ACTIVE_FAULT_LATCHED2_H_
...
#endif  // DELPHI_MRR_MSGS__MSG__ACTIVE_FAULT_LATCHED2_H_
