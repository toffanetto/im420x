...
#ifndef KARTECH_LINEAR_ACTUATOR_MSGS__MSG__ZEROING_MESSAGE_RPT_H_
#define KARTECH_LINEAR_ACTUATOR_MSGS__MSG__ZEROING_MESSAGE_RPT_H_
...
#endif  // KARTECH_LINEAR_ACTUATOR_MSGS__MSG__ZEROING_MESSAGE_RPT_H_
