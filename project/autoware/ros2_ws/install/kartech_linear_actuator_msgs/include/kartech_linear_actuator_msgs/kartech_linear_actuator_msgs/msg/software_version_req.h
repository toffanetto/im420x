...
#ifndef KARTECH_LINEAR_ACTUATOR_MSGS__MSG__SOFTWARE_VERSION_REQ_H_
#define KARTECH_LINEAR_ACTUATOR_MSGS__MSG__SOFTWARE_VERSION_REQ_H_
...
#endif  // KARTECH_LINEAR_ACTUATOR_MSGS__MSG__SOFTWARE_VERSION_REQ_H_
