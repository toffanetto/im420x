...
inline void to_flow_style_yaml(
  const ReassignCommandIdCmd & msg,
  std::ostream & out)
{
  out << "{";
  // member: header
  ...
  // member: command_id_index
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.command_id_index, out);
    out << ", ";
  }
  ...
  {
    out << "user_command_id: ";
    rosidl_generator_traits::value_to_yaml(msg.user_command_id, out);
    out << ", ";
  }
  ...
  // member: disable_default_command_id
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.disable_default_command_id, out);
  }
  out << "}";
...
inline std::string to_yaml(const ReassignCommandIdCmd & msg, bool use_flow_style = false)
{
