...
#ifndef KARTECH_LINEAR_ACTUATOR_MSGS__MSG__POSITION_CMD_H_
#define KARTECH_LINEAR_ACTUATOR_MSGS__MSG__POSITION_CMD_H_
...
#endif  // KARTECH_LINEAR_ACTUATOR_MSGS__MSG__POSITION_CMD_H_
