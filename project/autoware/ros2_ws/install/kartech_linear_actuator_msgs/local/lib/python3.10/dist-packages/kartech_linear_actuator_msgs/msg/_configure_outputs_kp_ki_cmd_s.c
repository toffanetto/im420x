...
bool kartech_linear_actuator_msgs__msg__configure_outputs_kp_ki_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kartech_linear_actuator_msgs.msg._configure_outputs_kp_ki_cmd.ConfigureOutputsKpKiCmd", full_classname_dest, 85) == 0);
  }
  kartech_linear_actuator_msgs__msg__ConfigureOutputsKpKiCmd * ros_message = _ros_message;
  {  // header
  ...
  {  // kp
    ...
    ros_message->kp = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // ki
    ...
    assert(PyLong_Check(field));
    ros_message->ki = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ConfigureOutputsKpKiCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kartech_linear_actuator_msgs.msg._configure_outputs_kp_ki_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ConfigureOutputsKpKiCmd");
  ...
  {  // kp
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->kp);
    {
  ...
  {  // ki
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->ki);
    {
