...
class Init_SpawnObject_Request_frame_id
{
public:
  explicit Init_SpawnObject_Request_frame_id(::carla_msgs::srv::SpawnObject_Request & msg)
  : msg_(msg)
  {}
  Init_SpawnObject_Request_attributes frame_id(::carla_msgs::srv::SpawnObject_Request::_frame_id_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_SpawnObject_Request_frame_id id(::carla_msgs::srv::SpawnObject_Request::_id_type arg)
  {
    msg_.id = std::move(arg);
    return Init_SpawnObject_Request_frame_id(msg_);
  }
