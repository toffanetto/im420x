    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'neobotix_usboard_msgs.msg.Sensors')
            logger.debug(
            ...
            from neobotix_usboard_msgs.msg import SensorData
...
class Sensors(metaclass=Metaclass_Sensors):
    ...
    _fields_and_field_types = {
        ...
        'sensors': 'sequence<neobotix_usboard_msgs/SensorData>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['neobotix_usboard_msgs', 'msg'], 'SensorData')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'sensors' field must be a set or sequence and each value of type 'SensorData'"
        self._sensors = value
