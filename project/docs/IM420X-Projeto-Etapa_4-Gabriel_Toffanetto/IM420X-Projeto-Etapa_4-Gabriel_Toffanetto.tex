...
%                  Presentation info	              %
% --------------------------------------------------- %
\title[microAutoware: Autoware para microcontroladores]{microAutoware: Arquitetura HIL para teste de sistemas embarcados como \textit{vehicle interface} de veículos autônomos baseados no Autoware}
...
\begin{frame}{Ambiente de testes}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.85\linewidth]{microautoware_testing_initialization}
...
\begin{frame}{\textit{Fail-safe}: perda comunicação com Autoware}
	...
	\begin{figure}[H]
		\centering
		\movie[width=0.85\textwidth,height=0.478\textwidth,poster,autostart,loop]{\includegraphics[width=0.85\linewidth]{microautoware_lost_autoware}}{microautoware_lost_autoware.mp4}
...
\begin{frame}{Modo de emergência: Perda de sinais do veículo}
	...
	\begin{figure}[H]
		\centering
		\movie[width=0.85\textwidth,height=0.478\textwidth,poster,autostart,loop]{\includegraphics[width=0.85\linewidth]{microautoware_lost_carla}}{microautoware_lost_carla.mp4}
...
\begin{frame}{Repositório no GitHub}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.75\linewidth]{repo}
		\caption{Repositório microAutoware -- Derivado de \href{https://github.com/micro-ROS/micro_ros_stm32cubemx_utils}{github.com/micro-ROS/micro\_ros\_stm32cubemx\_utils}}
		\label{fig:repo}
	\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8 \linewidth]{repo_readme}
	\caption{Repositório microAutoware -- README.}
	\label{fig:repo_readme}
\end{figure}
...
\begin{frame}{Conclusão}
	...
	\begin{columns}
		...
		\begin{column}{0.435\textwidth}
			...
			\begin{block}{Problemas pendentes de resolução}
		...
		\begin{column}{0.435\textwidth}
			...
			\begin{block}{Trabalhos futuros}
				...
				\begin{itemize}
					...
					\pause
					\item Potêncializar a integração da \textit{vehicle interface} com o Autoware.
				\end{itemize}
...
\begin{frame}{Apêndices}
	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{figure}[H]
				\centering
				\href{https://github.com/LMA-FEM-UNICAMP/microautoware_vehicle_inferface_stm32/tree/humble}{\includegraphics[width=0.8\linewidth]{qr_code_github}}
